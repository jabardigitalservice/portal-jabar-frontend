<template>
  <div v-show="isMenuActive">
    <ul
      class="bg-green-800 w-full absolute top-full left-0 border-t border-white pt-7 pb-10 px-8 z-10 bg-no-repeat"
      :style="{ backgroundImage: `url('/images/menu.png')`, backgroundPosition: '94% 100%' }"
    >
      <div class="container flex mx-auto items-start z-10">
        ...
        <div class="text-white cursor-pointer" tabindex="0" @click.stop="setActiveMenu">
          <!--
          @todo
          use icon from jabar design system
          -->
    ...
    <div class="bg-black opacity-20 fixed w-screen h-screen top-20 left-0" @click.stop="setActiveMenu" />
  </div>
</template>
