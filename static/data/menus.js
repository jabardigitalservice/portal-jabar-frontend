export const navigationMenu = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: '/icons/pendidikan-dan-pembelajaran.svg',
...
export const featuredProgramMenu = [
  ...
  },
  {
    ...
    description: 'Temukan informasi dan akses layanan tentang Organisasi Perangkat Daerah di Jawa Barat',
    icon: '/icons/ekosistem-data-jabar.svg',
...
export const quickLinkMenu = [
  ...
  },
  {
    ...
    icon: '/icons/sasaran-kinerja-pegawai.svg',
  ...
  },
  {
    ...
    icon: '/icons/info-harga-pangan.svg',
